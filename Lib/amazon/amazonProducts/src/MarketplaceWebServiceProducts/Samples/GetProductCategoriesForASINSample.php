...
class GetProductCategoriesForASIN
{
    ...
    public function __construct($amazonmws)
    {
         ...
         ***********************************************************************/
         ...
         $this->request->setASIN($amazonmws->productASIN);
        //$this->request->setASIN('B00VARIO46');
    }
/**
 ...
 */
    ...
    public function invokeGetProductCategoriesForASIN(MarketplaceWebServiceProducts_Interface $service, $request)
    {
        try {
            ...
            $category_arr = json_decode($jsonxml, true);
