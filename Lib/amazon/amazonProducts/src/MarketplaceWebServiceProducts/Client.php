...
require_once($path.'MarketplaceWebServiceProducts/Interface.php');
...
{
    const PATH = '/../Lib/amazon/amazonProducts/src/';
    ...
    public function getCompetitivePricingForASIN($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetCompetitivePricingForASINRequest)) {
            require_once(getcwd().'MarketplaceWebServiceProducts/Model/GetCompetitivePricingForASINRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetCompetitivePricingForASINResponse.php');
    ...
    public function getCompetitivePricingForSKU($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetCompetitivePricingForSKURequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetCompetitivePricingForSKURequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetCompetitivePricingForSKUResponse.php');
    ...
    public function getLowestOfferListingsForASIN($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetLowestOfferListingsForASINRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestOfferListingsForASINRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestOfferListingsForASINResponse.php');
    ...
    public function getLowestOfferListingsForSKU($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetLowestOfferListingsForSKURequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestOfferListingsForSKURequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestOfferListingsForSKUResponse.php');
    ...
    public function getLowestPricedOffersForASIN($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForASINRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForASINRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForASINResponse.php');
    ...
    public function getLowestPricedOffersForSKU($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForSKURequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForSKURequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetLowestPricedOffersForSKUResponse.php');
    ...
    public function getMatchingProduct($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetMatchingProductRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMatchingProductRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMatchingProductResponse.php');
    ...
    public function getMatchingProductForId($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetMatchingProductForIdRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMatchingProductForIdRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMatchingProductForIdResponse.php');
    ...
    public function getMyPriceForASIN($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetMyPriceForASINRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMyPriceForASINRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMyPriceForASINResponse.php');
    ...
    public function getMyPriceForSKU($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetMyPriceForSKURequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMyPriceForSKURequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetMyPriceForSKUResponse.php');
    ...
    public function getProductCategoriesForASIN($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetProductCategoriesForASINRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetProductCategoriesForASINRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetProductCategoriesForASINResponse.php');
    ...
    public function getProductCategoriesForSKU($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetProductCategoriesForSKURequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetProductCategoriesForSKURequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetProductCategoriesForSKUResponse.php');
    ...
    public function getServiceStatus($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_GetServiceStatusRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetServiceStatusRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/GetServiceStatusResponse.php');
    ...
    public function listMatchingProducts($request)
    {
        if (!($request instanceof MarketplaceWebServiceProducts_Model_ListMatchingProductsRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/ListMatchingProductsRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/ListMatchingProductsResponse.php');
    ...
    */
    ...
    private function _extractResponseHeaderMetadata($rawHeaders)
    {
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceProducts/Model/ResponseHeaderMetadata.php');
