...
class MarketplaceWebServiceProducts_Model_IdentifierType extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields =  [
        'MarketplaceASIN' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_ASINIdentifier'],
        'SKUIdentifier' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_SellerSKUIdentifier'],
        ];
