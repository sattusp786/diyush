...
class MarketplaceWebServiceProducts_Model_LowestOfferListingType extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields =  [
        'Qualifiers' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_QualifiersType'],
        'NumberOfOfferListingsConsidered' => ['FieldValue' => null, 'FieldType' => 'int'],
        'SellerFeedbackCount' => ['FieldValue' => null, 'FieldType' => 'int'],
        'Price' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_PriceType'],
