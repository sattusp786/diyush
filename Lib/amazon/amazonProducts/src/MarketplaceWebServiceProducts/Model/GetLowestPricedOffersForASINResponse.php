...
class MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForASINResponse extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields =  [
        'GetLowestPricedOffersForASINResult' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForASINResult'],
        'ResponseMetadata' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_ResponseMetadata'],
        'ResponseHeaderMetadata' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_ResponseHeaderMetadata'],
        ];
