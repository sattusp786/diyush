...
class MarketplaceWebServiceProducts_Model_OfferType extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields =  [
        'BuyingPrice' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_PriceType'],
        'RegularPrice' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_MoneyType'],
