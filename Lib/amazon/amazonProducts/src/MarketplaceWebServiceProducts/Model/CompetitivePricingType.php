...
class MarketplaceWebServiceProducts_Model_CompetitivePricingType extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields =  [
        'CompetitivePrices' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_CompetitivePriceList'],
        'NumberOfOfferListings' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_NumberOfOfferListingsList'],
        'TradeInValue' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_MoneyType'],
        ];
