...
class MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForSKUResult extends MarketplaceWebServiceProducts_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'Identifier' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_GetLowestPricedOffersSkuIdentifier'],
        'Summary' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_Summary'],
        'Offers' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_SKUOfferDetailList'],
        ];
