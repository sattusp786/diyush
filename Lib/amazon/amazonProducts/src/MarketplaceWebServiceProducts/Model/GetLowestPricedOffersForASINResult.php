...
class MarketplaceWebServiceProducts_Model_GetLowestPricedOffersForASINResult extends MarketplaceWebServiceProducts_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'Identifier' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_GetLowestPricedOffersAsinIdentifier'],
        'Summary' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_Summary'],
        'Offers' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_ASINOfferDetailList'],
        ];
