...
class MarketplaceWebServiceProducts_Model_GetMatchingProductForIdResult extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields =  [
        'Products' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_ProductList'],
        'Error' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_Error'],
