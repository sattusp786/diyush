...
class MarketplaceWebServiceProducts_Model_Product extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields =  [
        'Identifiers' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_IdentifierType'],
        'AttributeSets' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_AttributeSetList'],
        'Relationships' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_RelationshipList'],
        'CompetitivePricing' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_CompetitivePricingType'],
        'SalesRankings' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_SalesRankList'],
        'LowestOfferListings' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_LowestOfferListingList'],
        'Offers' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceProducts_Model_OffersList'],
        ];
