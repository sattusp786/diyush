...
class MarketplaceWebServiceOrders_Model_OrderItem extends MarketplaceWebServiceOrders_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'PointsGranted' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_PointsGrantedDetail'],
        'ItemPrice' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'ShippingPrice' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'GiftWrapPrice' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'ItemTax' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'ShippingTax' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'GiftWrapTax' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'ShippingDiscount' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'PromotionDiscount' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'PromotionIds' => ['FieldValue' => [], 'FieldType' => ['string'], 'ListMemberName' => 'PromotionId'],
        'CODFee' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'CODFeeDiscount' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_Money'],
        'GiftMessageText' => ['FieldValue' => null, 'FieldType' => 'string'],
        'GiftWrapLevel' => ['FieldValue' => null, 'FieldType' => 'string'],
        'InvoiceData' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_InvoiceData'],
        ...
        'BuyerCustomizedInfo' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_BuyerCustomizedInfoDetail'],
        ];
