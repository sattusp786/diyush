...
require_once($path.'MarketplaceWebServiceOrders/Model.php');
...
class MarketplaceWebServiceOrders_Model_ListOrdersByNextTokenResponse extends MarketplaceWebServiceOrders_Model
{
    ...
    {
        $this->_fields =  [
        'ListOrdersByNextTokenResult' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_ListOrdersByNextTokenResult'],
        'ResponseMetadata' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_ResponseMetadata'],
        'ResponseHeaderMetadata' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceOrders_Model_ResponseHeaderMetadata'],
        ];
