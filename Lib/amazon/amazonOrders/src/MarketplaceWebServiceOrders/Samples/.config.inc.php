<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    // define('AWS_ACCESS_KEY_ID', $amazonmws->accessKeyId);
    // define('AWS_SECRET_ACCESS_KEY', $amazonmws->secretKey);
    ...
    ***********************************************************************/
    // define('APPLICATION_NAME', $amazonmws->applicationName);
    // define('APPLICATION_VERSION', $amazonmws->applicationVersion);
    ...
    * marketplace ID.
    ***********************************************************************/
    // define ('MERCHANT_ID', $amazonmws->sellerId);
    // define ('MARKETPLACE_ID', $amazonmws->marketplaceId);
    ...
    ***********************************************************************/
    ...
    function autoloadOrders($className){
        $filePath = str_replace('_', DIRECTORY_SEPARATOR, $className) . '.php';
        $includePaths = explode(PATH_SEPARATOR, get_include_path());
        $path = '/../Lib/amazon/amazonOrders/src/';
    ...
    spl_autoload_register('autoloadOrders');
