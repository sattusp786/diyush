 ...
 */
$path = getcwd().'/../Lib/amazon/amazonOrders/src/';
require_once($path.'MarketplaceWebServiceOrders/Interface.php');
...
{
    const PATH = '/../Lib/amazon/amazonOrders/src/';
    ...
    public function getOrder($request)
    {
        if (!($request instanceof MarketplaceWebServiceOrders_Model_GetOrderRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/GetOrderRequest.php');
            $request = new MarketplaceWebServiceOrders_Model_GetOrderRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetOrder';
        $httpResponse = $this->_invoke($parameters);
        require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/GetOrderResponse.php');
    ...
    public function getServiceStatus($request)
    {
        if (!($request instanceof MarketplaceWebServiceOrders_Model_GetServiceStatusRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/GetServiceStatusRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/GetServiceStatusResponse.php');
    ...
    public function listOrderItems($request)
    {
        if (!($request instanceof MarketplaceWebServiceOrders_Model_ListOrderItemsRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrderItemsRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrderItemsResponse.php');
    ...
    public function listOrderItemsByNextToken($request)
    {
        if (!($request instanceof MarketplaceWebServiceOrders_Model_ListOrderItemsByNextTokenRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrderItemsByNextTokenRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrderItemsByNextTokenResponse.php');
    ...
    public function listOrders($request)
    {
        if (!($request instanceof MarketplaceWebServiceOrders_Model_ListOrdersRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrdersRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrdersResponse.php');
    ...
    public function listOrdersByNextToken($request)
    {
        if (!($request instanceof MarketplaceWebServiceOrders_Model_ListOrdersByNextTokenRequest)) {
            require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrdersByNextTokenRequest.php');
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ListOrdersByNextTokenResponse.php');
    ...
    */
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Exception.php');
    ...
    private function _extractHeadersAndBody($response)
    {
        ...
        for ($count = 0; $count < count($responseComponents) && $body == null; $count++) {
            ...
            if ($responseStatus != null &&
                ...
                $sxe=new SimpleXMLElement($responseComponents[$count]);
                foreach ($sxe->children() as $child) {
                    if (is_object($child) && isset($child->Status)) {
                        $this->serviceStatus = $child->Status;
                    }
                    if (is_object($child->children())) {
    ...
    private function _extractResponseHeaderMetadata($rawHeaders)
    {
        ...
        require_once(getcwd().self::PATH.'MarketplaceWebServiceOrders/Model/ResponseHeaderMetadata.php');
